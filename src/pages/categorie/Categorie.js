                        ...
                        <div className="container-fluid">
                            <nav aria-label="chapelure" role="navigation" _mstaria-label="157144" _msthash="63">
                                <ol className="breadcrumb adminx-page-breadcrumb">
                                    ...
                                    <li className="breadcrumb-item active  aria-current=" _msttexthash="234351" _msthash="66">Gestion des categories</li>
                                </ol>
                                </nav>

                                <div className="pb-3">
                                <h1 _msttexthash="234351" _msthash="67">Gestion des Categoires</h1>
                                </div>
                                ...
                                <div className="col-lg-8">
                                    ...
                                    <div className="card-header d-flex justify-content-between align-items-center">
                                        <div className="card-header-title" _msttexthash="183612" _msthash="68">List des Categories</div>
                                ...
                                <div className="col-lg-4">
                                    ...
                                    <div className="card-header">
                                        ...
                                        <AddCategorie fonc={this.getCategories} />
                                    </div>
                                </div>
                            </div>
                        </div>
