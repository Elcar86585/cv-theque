                ...
                exp && exp.map(expe => {
                    ...
                    axios.post('experiences', formExp).then(resp => {
                        if(resp.status === 201) {
                            ...
                            NotificationManager.warning('Une erreur est survenue lor de la validation de votre experience', 'Erreur', 2000)
                        }
                    })            
                })
                ...
                lois && lois.map(loisir => {
                    ...
                    axios.post('loisirs', formLoisir).then(resp => {
                        if(resp.status === 201) {
                            ...
                            NotificationManager.warning('Une erreur est survenue lor de la validation de votre Loisir', 'Erreur', 2000)
                        }
                    })            
                })
                ...
                lang && lang.map(langag => {
                    ...
                    axios.post('langages', formLang).then(resp => {
                        if(resp.status === 201) {
                            ...
                            NotificationManager.warning('Une erreur est survenue lor de la validation de vos langages', 'Erreur', 2000)
                        }
                    })            
                })
                ...
                informa && informa.map(infor => {
                    ...
                    axios.post('informatiques', forminformatique).then(resp => {
                        if(resp.status === 201) {
                            ...
                            NotificationManager.warning('Une erreur est survenue lor de la validation de vos connaissance en informatique', 'Erreur', 2000)
                        }
                    })            
                })
                ...
                diplo && diplo.map(diplome => {
                    ...
                    axios.post('diplomes', formDiplom).then(resp => {
                        if(resp.status === 201) {
                            ...
                            NotificationManager.warning('Une erreur est survenue lor de la validation de vos Diplomes et formations', 'Erreur', 2000)
                        }
                    })        
                })
